...
public class TypeClassificationTests {
    ...
    public void primitiveTypes () {
        ...
        for (Field field : fields) {
            ...
            switch (field.getType().getName()) {
                case "boolean":
                    assert fieldType instanceof BooleanDataType;
                    break;
                case "byte":
                    assert fieldType instanceof ByteDataType;
                    break;
                case "char":
                    assert fieldType instanceof CharDataType;
                    break;
                case "double":
                    assert fieldType instanceof DoubleDataType;
                    break;
                case "float":
                    assert fieldType instanceof FloatDataType;
                    break;
                case "int":
                    assert fieldType instanceof IntDataType;
                    break;
                case "long":
                    assert fieldType instanceof LongDataType;
                    break;
                case "short":
                    assert fieldType instanceof ShortDataType;
                    break;
                case "java.lang.String":
                    assert fieldType instanceof StringDataType;
                    break;
                default:
                    assert false;
            }
    ...
    public void primitiveArrayTypes () {
        ...
        for (Field field : fields) {
            ...
            switch (field.getType().getComponentType().getName()) {
                case "boolean":
                    assert fieldType instanceof BooleanArrayDataType;
                    break;
                case "byte":
                    assert fieldType instanceof ByteArrayDataType;
                    break;
                case "char":
                    assert fieldType instanceof CharArrayDataType;
                    break;
                case "double":
                    assert fieldType instanceof DoubleArrayDataType;
                    break;
                case "float":
                    assert fieldType instanceof FloatArrayDataType;
                    break;
                case "int":
                    assert fieldType instanceof IntArrayDataType;
                    break;
                case "long":
                    assert fieldType instanceof LongArrayDataType;
                    break;
                case "short":
                    assert fieldType instanceof ShortArrayDataType;
                    break;
                case "java.lang.String":
                    assert fieldType instanceof StringArrayDataType;
                    break;
                default:
                    assert false;
            }
    ...
    @Test
    public void primitiveObjectTypes () {
        ...
        for (Field field : fields) {
            ...
            switch (field.getType().getName()) {
                case "java.lang.Boolean":
                    assert fieldType instanceof BooleanObjectDataType;
                    break;
                case "java.lang.Byte":
                    assert fieldType instanceof ByteObjectDataType;
                    break;
                case "java.lang.Character":
                    assert fieldType instanceof CharacterObjectDataType;
                    break;
                case "java.lang.Double":
                    assert fieldType instanceof DoubleObjectDataType;
                    break;
                case "java.lang.Float":
                    assert fieldType instanceof FloatObjectDataType;
                    break;
                case "java.lang.Integer":
                    assert fieldType instanceof IntegerObjectDataType;
                    break;
                case "java.lang.Long":
                    assert fieldType instanceof LongObjectDataType;
                    break;
                case "java.lang.Short":
                    assert fieldType instanceof ShortObjectDataType;
                    break;
                default:
                    throw new IllegalArgumentException("Field is not primitive object");
            }
        }
    }

    @Test
    public void primitiveObjectArrayTypes () {
        ...
        for (Field field : fields) {
            ...
            switch (field.getType().getComponentType().getName()) {
                case "java.lang.Boolean":
                    assert fieldType instanceof BooleanObjectArrayDataType;
                    break;
                case "java.lang.Byte":
                    assert fieldType instanceof ByteObjectArrayDataType;
                    break;
                case "java.lang.Character":
                    assert fieldType instanceof CharacterObjectArrayDataType;
                    break;
                case "java.lang.Double":
                    assert fieldType instanceof DoubleObjectArrayDataType;
                    break;
                case "java.lang.Float":
                    assert fieldType instanceof FloatObjectArrayDataType;
                    break;
                case "java.lang.Integer":
                    assert fieldType instanceof IntegerObjectArrayDataType;
                    break;
                case "java.lang.Long":
                    assert fieldType instanceof LongObjectArrayDataType;
                    break;
                case "java.lang.Short":
                    assert fieldType instanceof ShortObjectArrayDataType;
                    break;
                default:
                    throw new IllegalArgumentException("Field is not primitive object");
            }
